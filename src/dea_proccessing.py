...
def filtered_df(
    ...
    """This function return a pandaas dataframe with the passed columns or the original columns without the rm_column.

    Args:
        df (pd.DataFrame): _description_
        columns (Union[None, list[str]], optional): The columns that you want to have in the dataframe. Defaults to None.
        rm_columns (Union[None, list[str]], optional): The columns to be remove from the original dataframe. Defaults to None.

    Returns:
        pd.DataFrame: A pandas dataframe with the filtered columns, or the original dataframe if neither `columns` or `rm_columns` was passed.
    """
